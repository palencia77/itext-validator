...
public class ItextCertificateValidation extends ItextSignatureIntegrity {
    ...
    public static final String EBARCI = "C:\\POC\\CertVencido\\CertExchange.cer";

    public static final String EXAMPLE1 = "C:\\POC\\CertRevocado\\DOCUMENTO FIRMADO LUEGO DE HABER SOLICITADO LA REVOCACIÓN DEL CERTIFICADO_firmado.pdf";
    public static final String EXAMPLE2 = "C:\\POC\\CertVencido\\2018-09-19-dos-espacios-firma_v3.pdf";
    public static final String EXAMPLE3 = "C:\\POC\\CertRevocado\\DOCUMENTO FIRMADO ANTES DE REVOCAR_firmado.pdf";
    ...
    public static void main(String[] args) throws IOException,
        ...
        ItextCertificateValidation app = new ItextCertificateValidation();
        ...
        //ks.setCertificateEntry("ebarci", cf.generateCertificate(new FileInputStream(EBARCI)));
        app.setKeyStore(ks);
